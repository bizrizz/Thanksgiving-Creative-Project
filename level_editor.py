...
while run:
	...
	#legend
	draw_text('Legend:', font, white, tile_size, 10)
	draw_text('0=Empty 1=Dirt 2=Grass 3=Enemy 4=Platform(H) 5=Platform(V)', font, white, tile_size, 35)
	draw_text('6=Lava 7=Coin 8=Exit 9=Level Collectible', font, white, tile_size, 60)
